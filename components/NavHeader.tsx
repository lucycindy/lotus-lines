  ...
  return (
    <header className="absolute top-0 left-0 w-full z-[60] pointer-events-none">
      ...
      <div className="absolute top-[16px] right-[20px] pointer-events-auto">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">

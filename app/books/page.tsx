                        ...
                        >
                            ...
                            <div className="flex items-center min-w-0 flex-1 py-[var(--sp-md)] px-[var(--sp-sm)]">
                                <div className="min-w-0 w-full pr-[var(--sp-md)]">
                                    <h2 className="books-card-title font-medium text-black group-hover:text-[#b83143] transition-colors line-clamp-1">
                                        {post.Title || "Untitled"}
                                    </h2>
                                    {post.Description ? (
                                        <div className="flex items-center mt-[var(--sp-xs)]">
                                            <p className="books-card-desc text-[#737373] italic">
                                                {post.Description}
                                            </p>
                                        </div>
                                    ) : null}

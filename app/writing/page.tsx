...
export default async function WritingPage() {
  ...
  return (
    <div className="min-h-screen content-wrapper pb-[var(--sp-3xl)]">
      ...
      <p className="mt-[var(--sp-xs)] text-center text-[13px] md:text-[clamp(0.85rem,1vw,1rem)] text-[#737373]">
              ...
              >
                ...
                <div className="flex min-w-0 flex-1 flex-col justify-center items-start md:pl-[var(--sp-xl)] py-[var(--sp-md)] px-[var(--sp-sm)]">
                  <div className="min-w-0 w-full pr-[var(--sp-md)]">
                    <h2 className="text-[var(--fs-body)] font-medium text-black group-hover:text-[#b83143] transition-colors line-clamp-1">
                      {post.Title || "Untitled"}
                    </h2>
                    {post.Description ? (
                      <div className="flex items-center mt-[var(--sp-xs)]">
                        <p className="text-[var(--fs-caption)] text-[#737373] italic line-clamp-1">
                          {post.Description}
                        </p>
                      </div>
                    ) : null}
